...
public class Resources {
	public static final String BACKGROUND = "res/images/Mybrainhurts.gif";
	...
	public static final String NYAN = "res/images/NyanCat.gif";
	
	public static final String BANANA_SOUND = "res/sounds/banana_song.wav";
